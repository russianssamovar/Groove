    ...
    return (
      <Grid item xs={3} direction="row" justify="center" alignItems="center">
        <Paper elevation={1} style={{ height: 140, padding: 5 }}>
          <Grid container>
            <Grid item xs={3}>
              <Avatar alt={this.props.account.firstName} src={this.props.account.avatarUrl} style={{ width: 45, height: 45 }} />
            </Grid>
            <Grid style={{ marginTop: 10 }} item xs={6}>
              <FormLabel filled={true} >{this.props.account.firstName} {this.props.account.lastName}</FormLabel>
            </Grid>
            <Grid item xs={3}>
