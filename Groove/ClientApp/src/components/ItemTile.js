...
export class ItemTile extends Component {
  ...
  oauthHandle(event)
{
  var newWindow = window.open("https://oauth.vk.com/authorize?client_id=6854870&display=page&redirect_uri=" + window.location.host + "/accounts/add&scope=offline&response_type=code&v=5.92", 'name', 'height=350,width=700');
    if (window.focus) {
      newWindow.focus();
    }
}
